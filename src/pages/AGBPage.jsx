    ...
    <main className="pt-16">
      <div className="bg-gradient-to-b from-gray-900 to-gray-800 py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl font-bold mb-6 text-center">Allgemeine Geschäftsbedingungen</h1>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-800/50 border border-gray-700 rounded-xl p-8 space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 text-blue-400">§ 1 Geltungsbereich</h2>
              ...
              <section>
                <h2 className="text-2xl font-bold mb-4 text-blue-400">§ 2 Vertragsschluss</h2>
                <p className="text-gray-300 leading-relaxed mb-3">
                  (1) Angebote des Auftragnehmers sind freibleibend und unverbindlich, sofern nicht ausdrücklich 
                  etwas anderes vereinbart ist.
                </p>
                <p className="text-gray-300 leading-relaxed mb-3">
                  (2) Der Vertrag kommt durch schriftliche Auftragsbestätigung des Auftragnehmers oder durch 
              ...
              <section>
                ...
                <p className="text-gray-300 leading-relaxed mb-3">
                  (2) Der Auftraggeber erhält nach vollständiger Bezahlung ein nicht-ausschließliches, 
